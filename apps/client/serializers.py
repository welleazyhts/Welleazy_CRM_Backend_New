...
class ClientSPOCPayloadSerializer(serializers.ModelSerializer):
...
class ClientDocumentPayloadSerializer(serializers.ModelSerializer):
    class Meta:
        model = ClientDocument
        fields = '__all__'
        read_only_fields = ['created_at', 'updated_at', 'created_by', 'updated_by', 'client']

class ClientPayloadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Client
        fields = '__all__'
        read_only_fields = ['corporate_code', 'created_at', 'updated_at', 'created_by', 'updated_by']
