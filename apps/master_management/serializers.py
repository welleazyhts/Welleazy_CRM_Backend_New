...
from .models import (MasterProduct, MasterProductFor, MasterProductSubCategory, ServiceMapping, 
                    ...
                    MasterSpecialtiesTest, MasterUploadFormat, MasterLoginType, MasterGender, MasterRelationship , MasterLanguage , GymVendors , CaseStatus)
...
class MasterGenderSerializer(serializers.ModelSerializer):
    created_by_name = serializers.CharField(source='created_by.name', read_only=True)
    updated_by_name = serializers.CharField(source='updated_by.name', read_only=True)
